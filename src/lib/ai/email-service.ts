...
export const ROCOTO_IDENTITY = `=== ABOUT ROCOTO (use ONLY these facts, never invent capabilities or results) ===
...
export const CUSTOMER_SYSTEM_PROMPT = `You are Daniel Chalco writing a cold email.
...
export const INVESTOR_SYSTEM_PROMPT = `You are Daniel Chalco writing a cold email to an investor.
...
- BANNED PHRASES: "landscape," "intersection," "game-changer," "I hope this finds you well," "I came across," "I was impressed by," "I noticed that," "I wanted to reach out," "fascinating intersection," "fascinating attack surface," "fun contrast," "perfect storm," "creates a perfect," "massive attack surface," "across all," "across your", "just checking in", "circling back", "wanted to follow up", "bumping this", "inspired by"
...
export const PARTNERSHIP_SYSTEM_PROMPT = `You are Daniel Chalco writing a cold email to a potential partner.
