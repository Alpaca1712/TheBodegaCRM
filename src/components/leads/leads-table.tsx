                    ...
                    {lead.contact_email && (
                      <div className="flex items-center">
                        ...
                        <CopyButton
                          ...
                          label="Email"
                          className="ml-1.5 p-1 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                        />
                      </div>
                    )}
                  </div>
