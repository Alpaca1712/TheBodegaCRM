            ...
            <div className="flex items-center justify-between px-4 py-3 bg-zinc-50 dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700">
              ...
              <div className="flex items-center gap-2">
                <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                  <CopyButton text={fullText} label="Email" className="flex items-center gap-1 px-2 py-1 text-[10px] font-medium bg-zinc-100 dark:bg-zinc-800" />
                </div>
            ...
            {replyContent && (
              <div className="border-t border-zinc-200 dark:border-zinc-700 px-4 py-3 bg-green-50/50 dark:bg-green-950/20">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <CopyButton text={replyContent} label="Reply" className="flex items-center gap-1 px-2 py-1 text-[10px] font-medium bg-zinc-100 dark:bg-zinc-800" />
                </div>
