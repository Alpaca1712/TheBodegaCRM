              ...
              <div className="flex items-center gap-2">
                <div className="opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                  <CopyButton
                    ...
                    label="Email"
                    showText
                    className="px-2 py-1 text-[10px] font-medium text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 focus:opacity-100"
                  />
                </div>
              ...
              <div className="border-t border-zinc-200 dark:border-zinc-700 px-4 py-3 bg-green-50/50 dark:bg-green-950/20">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <CopyButton
                    ...
                    label="Reply"
                    showText
                    className="px-2 py-1 text-[10px] font-medium text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700"
                  />
                </div>
