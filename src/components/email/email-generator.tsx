...
export default function EmailGenerator({ lead, emails = [], followUpType, onEmailSaved }: EmailGeneratorProps) {
  ...
  // Auto-generate when navigated from follow-ups page
  useEffect(() => {
    if (followUpType && !autoGenerated.current && !result) {
  ...
  if (!result) {
    return (
      <div className="text-center py-8">
        {isFollowUp && (
          <div className="mb-4 px-4 py-2 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 inline-block">
