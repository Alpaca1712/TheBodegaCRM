    ...
    <div className={`rounded-xl border ${urg.border} ${urg.bg} p-4 transition-all hover:shadow-sm`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col items-end gap-2 shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            {['initial_outreach', 'follow_up_1', 'follow_up_2', 'reply_needed', 'post_meeting'].includes(item.suggestedType) && (
              <button
                onClick={onMagicDraft}
                disabled={isProcessing}
                title="Magic Draft: One-click AI generation"
                className="p-2 text-zinc-500 hover:text-amber-500 bg-white/60 dark:bg-black/20 rounded-lg transition-colors disabled:opacity-50 border border-zinc-200/50 dark:border-zinc-800/50"
              >
