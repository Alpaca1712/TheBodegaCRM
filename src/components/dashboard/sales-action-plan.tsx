  ...
  return (
    <div className="rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-white dark:bg-zinc-900/50 p-5">
      ...
      <div className="space-y-3">
        {actions.map((action) => {
          const isActionProcessing = processingId === action.leadId;
          ...
          const canPrep = onPrep && action.category === 'meeting' && action.leadStage === 'meeting_booked' && action.ctaLabel === 'Generate prep';
