          ...
          >
            ...
            <div className="flex items-center gap-3 ml-4">
              <button
                ...
                title="Magic Draft: AI writes the email and moves lead to review"
                className="flex items-center justify-center h-8 w-8 text-zinc-400 hover:text-red-600 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg transition-colors disabled:opacity-50"
              >
                {isProcessing === lead.lead_id ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <Zap className="h-3.5 w-3.5" />}
              </button>
