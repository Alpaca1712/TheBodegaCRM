...
function defaultEventForStage(stageKey: string): CampaignEventType {
  ...
  if (stageKey === 'challenge_link_clicked') return 'challenge_link_clicked'
  if (stageKey === 'lead_magnet_sent') return 'lead_magnet_sent'
  if (stageKey === 'lead_magnet_requested') return 'lead_magnet_requested'
  if (stageKey === 'to_send') return 'stage_changed'
  if (stageKey === 'sent_waiting') return 'email_sent'
  if (stageKey === 'replied') return 'email_replied'
  if (stageKey === 'opted_in') return 'lead_magnet_requested'
  if (stageKey === 'nurture_lost') return 'no_response'
  if (stageKey === 'playbook_opt_in') return 'lead_magnet_requested'
  if (stageKey === 'replied_interested') return 'email_replied'
  if (stageKey === 'initial_email_sent') return 'email_sent'
  if (stageKey === 'offer_email_sent') return 'email_sent'
  if (stageKey === 'initial_email_drafted') return 'email_drafted'
  if (stageKey === 'offer_email_drafted') return 'email_drafted'
  if (stageKey === 'researched') return 'research_completed'
  if (stageKey === 'target_account_list') return 'conference_targeted'
  if (stageKey === 'target_list') return 'conference_targeted'
  ...
  if (stageKey === 'outreach_sent') return 'pre_event_outreach_sent'
