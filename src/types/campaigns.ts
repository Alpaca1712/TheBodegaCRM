...
export const CAMPAIGN_TEMPLATES: Record<CampaignTemplateKey, CampaignTemplate> = {
  ...
  linkedin_outbound_lead_magnet: {
    ...
    description: 'Manual LinkedIn outbound flow: message prospects, track replies, send the lead magnet, then move them toward the challenge and discovery.',
    ...
    sequenceSteps: [
      ...
      { key: 'reply', label: 'Track reply intent', timing: 'When they reply', channel: 'linkedin', goal: 'Use the reply to decide whether to send the lead magnet or handle it manually.' },
      { key: 'deliver', label: 'Deliver lead magnet', timing: 'After interest', channel: 'email', goal: 'Send the personalized lead magnet PDF or tracked challenge link.' },
